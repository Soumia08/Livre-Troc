...
function ListBooksResearch  ()  {
    ...
    const {data} = await axios.get('/books/search/'+new_mot); 
    ...
    setShowModal(false)
                ...
                <div className="row">
                  <div className="col-md-8 mx-auto">
                    <h2 className="text-center mb-4"> Résultat trouvés pour "{new_mot}" </h2>
      ...
      <a class="page-link" href="#" aria-label="Next">
        ...
        <span class="sr-only"></span>
                  ...
                  <SimpleModal
      title={"Emrunt de livre impossible"}
...
export default ListBooksResearch;