...
import fr.soumia.BOOKPROJECT.borrow.Borrow;
import fr.soumia.BOOKPROJECT.borrow.BorrowRepository;
...
public class BookController {
    ...
    public ResponseEntity updateBook(@PathVariable("bookId") String bookId, @Valid @RequestBody Book book) {
        ...
        bookToSave.setPicUrl(book.getPicUrl());
  ...
  //LIVRE DONT LE TRITRE CONTIENT
  	@GetMapping(value="/books-title/{title}", produces = "application/json")
  	public List<Book> findByTitleIsContaining(@PathVariable("title")  String title) {

  		List<Book> books = null;
  		books = bookRepository.findByTitleIsContaining(title);
  		System.out.println("##############################################################" );
  		return books;
  	}
	...
	@GetMapping(value = "books/search/{mot}")
	public ResponseEntity findBooksByKey( @PathVariable String mot) {
		
		List<Book> books = bookRepository.findBooksBykey(mot);
